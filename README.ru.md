...
> [!IMPORTANT]
> Сейчас это ранняя alpha-версия. Уже реализованы Host-хранилище и типизированный RPC, но sidebar и composer ещё не подключены. Поэтому установленный пакет пока не добавляет видимые draft-строки.
...
- Recovery через замену исчезнувшей blank Session без потери текста.
